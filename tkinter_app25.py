...
class Application(ctk.CTk):
    ...
    def show_login_window(self):
        ...
        ctk.CTkButton(self.login_window, text="Login", command=self.login, font=("Times New Roman", 9)).grid(row=4, column=0, columnspan=2, pady=10)
        ctk.CTkButton(self.login_window, text="Register", command=self.register, font=("Times New Roman", 9)).grid(row=5, column=0, columnspan=2, pady=10)
    ...
    def show_main_window(self):
        ...
        self.input_text = ctk.CTkTextbox(self, wrap='word', width=400, height=200, font=("Times New Roman", 12), yscrollcommand=self.input_scrollbar.set)
        ...
        self.submit_button = ctk.CTkButton(self, text="Submit", command=self.process_input, font=("Times New Roman", 9))
        ...
        self.output_text = ctk.CTkTextbox(self, wrap='word', width=400, height=200, font=("Times New Roman", 12), yscrollcommand=self.output_scrollbar.set)
        ...
        self.feedback_text = ctk.CTkTextbox(self, wrap='word', width=10, height=10, font=("Times New Roman", 12), yscrollcommand=self.feedback_scrollbar.set)
        ...
        self.submit_feedback_button = ctk.CTkButton(self, text="Submit Feedback", command=self.submit_feedback, font=("Times New Roman", 9))
        self.submit_feedback_button.grid(row=17, column=0, pady=5)

        self.submit_text_button = ctk.CTkButton(self, text="Submit Text", command=self.process_input, font=("Times New Roman", 9))
    ...
    def display_report(self):
        ...
        report_text = ctk.CTkTextbox(report_window, wrap='word', width=100, height=20, font=("Times New Roman", 12), yscrollcommand=report_scrollbar.set)
    ...
    def open_feedback_window(self):
        ...
        ctk.CTkLabel(self.feedback_window, text="Feedback Details:", font=("Times New Roman", 12)).pack(pady=10)

        ctk.CTkLabel(self.feedback_window, text="Relevance:", font=("Times New Roman", 12)).pack(pady=5)
        self.relevance_var = ctk.IntVar()
        ...
        ctk.CTkLabel(self.feedback_window, text="Accuracy:", font=("Times New Roman", 12)).pack(pady=5)
        self.accuracy_var = ctk.IntVar()
        ...
        ctk.CTkLabel(self.feedback_window, text="Fluency:", font=("Times New Roman", 12)).pack(pady=5)
        self.fluency_var = ctk.IntVar()
        ...
        ctk.CTkLabel(self.feedback_window, text="Additional Comments:", font=("Times New Roman", 12)).pack(pady=5)
        self.additional_comments_text = ctk.CTkTextbox(self.feedback_window, width=300, height=100, font=("Times New Roman", 12))
        self.additional_comments_text.pack(pady=5)

        ctk.CTkButton(self.feedback_window, text="Submit Feedback", command=self.submit_feedback_from_window, font=("Times New Roman", 12)).pack(pady=10)
