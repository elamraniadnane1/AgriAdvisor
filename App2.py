...
class Application(ctk.CTk):
    ...
    def show_main_window(self):
        ...
        self.input_text = ctk.CTkTextbox(self.scrollable_frame, wrap='word', width=400, height=200, font=("Helvetica", 14), yscrollcommand=self.input_scrollbar.set)
        ...
        self.submit_button = ctk.CTkButton(self.scrollable_frame, text="Submit", command=self.process_input, font=("Helvetica", 12))
        ...
        self.output_text = ctk.CTkTextbox(self.scrollable_frame, wrap='word', width=400, height=200, font=("Helvetica", 14), yscrollcommand=self.output_scrollbar.set)
        ...
        self.submit_feedback_button = ctk.CTkButton(self.scrollable_frame, text="Submit Feedback", command=self.submit_feedback, font=("Helvetica", 12))
        ...
        self.show_user_info_button.grid(row=18, column=1, pady=5)
    ...
    def open_feedback_window(self):
        logger.info("Feedback window method called.")
