...
class Application(tk.Tk):
    def __init__(self):
        ...
        self.speak_button = tk.Button(self, text="Read Aloud Output", command=self.read_aloud_output)
        self.speak_button.pack(pady=10)
        
        self.play_button = tk.Button(self, text="Play", command=play_audio)
        self.play_button.pack(pady=10)

        self.pause_button = tk.Button(self, text="Pause", command=pause_audio)
        self.pause_button.pack(pady=10)

        self.replay_button = tk.Button(self, text="Replay", command=replay_audio)
